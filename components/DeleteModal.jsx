...
function DeleteModal({ items, setItems, deleteModal, setDeleteModal }) {
    const confirmDelete = async () => {
        await fetch(`/api/item/${deleteModal}`, {
            method: "DELETE",
    ...
    return (
        ...
        >
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-evenly', mt: '10px' }}>
                ...
                <Button onClick={confirmDelete} sx={buttonStyles}>Confirm</Button>
            </Box>
        </Modal>
    );
}
